...
public class Reservaciones_Restaurante extends AppCompatActivity {
    ...
    private void cargarPlatillos(String URL) {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    Toast.makeText(Reservaciones_Restaurante.this, "CARGANDO...", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Reservaciones_Restaurante.this, "Error de conexion", Toast.LENGTH_SHORT).show();
                    }
                });
